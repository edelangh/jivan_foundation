...
<?PHP if ($LL == "en") { ?>
<iframe id="haWidget" allowtransparency="true" src="https://www.helloasso.com/associations/jivan/formulaires/1/widget/en" style="height: 100%;padding-top: -10em;width:100%;border:none;" onload="window.scroll(0, this.offsetTop)"></iframe>
<?PHP } else { ?>
