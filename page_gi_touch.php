  ...
  <div class="container onepage">
    <div class="row quotes">
      <div class="col-sm-8" style="text-align: center;">
        <h3 style="padding-bottom: 1em; text-align: left;">Leave a message</h3>
        <input id="mail-mail-area" type="email" placeholder="Your email address" class="letter-bg"></input>
        <textarea id="mail-text-area" placeholder="Your message" class="letter-bg"></textarea>
