...
$LANG = array(
  "title" => "",
  "title_what_we_do" => "NOTRE PROJET",
  "title_who_we_are" => "QUI SOMMES NOUS",
  "title_get_involved" => "S’ENGAGER",
  "title_who_sub_what" => "A propos de Jivan",
  "title_who_sub_story" => "Notre histoire",
  "title_who_sub_behind" => "Notre équipe",
  "title_get_touch" => "NOUS CONTACTER",
    ...
    "read_our_story" => "Notre histoire",
    "read_more" => "LIRE PLUS",
    "dear" => "Cher Jivan,",
    "your_mesg" => "Votre message",
    "your_mail" => "Votre email",
    "share" => "SHARE",
    "donate" => "SOUTENIR",
    "subscribe" => "SUBSCRIBE MONTHLY",
    "gi_text_1" => "Nous proposons diverses possibilités, un don unique ou périodique, mensuel ou autre et vous sommes très reconnaissants pour votre soutien - peu importe le montant, chaque don est important.",
...
"« Aucun enfant n’a choisi de naître dans un bidonville et de grandir dans la misère. Aucun enfant n’a choisi de faire des travaux dégradants et humiliants pour survivre. Il appartient à chacun de nous de rendre leur dignité aux enfants oubliés, de les respecter, les aimer, leur permettre d’accéder à l’éducation et leur donner l’élan pour demain. »",
    ...
    "result_body" => 
"Depuis 1995
C’est un long voyage que nous faisons ensemble avec les élèves, avec leurs parents quand les enfants ne sont pas seuls et les enseignants de SVM.
...
L’école comprend douze degrés incluant le baccalauréat et l’enseignement est donné en Anglais, Hindi et Urdu. SVM n’a pas pour seul objectif l’instruction mais également l’accompagnement des enfants dans leur développement personnel, amener la confiance dans leur coeur et le sourire dans leur vie. C’est un voyage que nous faisons ensemble depuis 1996 avec les élèves, avec leurs parents quand les enfants ne sont pas seuls et les enseignants de SVM.</p>",
    "who_what_body_part_2" => "<p>Jivan Association caritative est basée en Suisse et ses membres sont actifs dans le soutien à SVM depuis 1996, sous l’appellation Shanti Delhi de 1997 à 2006.</p>
<p>L’association fonctionne de manière indépendante et ne se rattache à aucun mouvement politique ou religieux. Les fonds nécessaires à son fonctionnement sont récoltés par la vente d’artisanat, les parrainages et les dons.</p>
...
En 2006, le bidonville de I.T.O. fut démoli, Delhi se préparait à recevoir les Jeux du Commonwealth et le gouvernement décida de délocaliser les bidonvilles à la périphérie de la capitale. Les habitants de I.T.O. décidèrent de rester à proximité du bidonville détruit, sur les trottoirs ou dans des petites chambres louées alentour. Il était impératif de poursuivre la scolarisation des enfants et l’école fut installée dans un petit bâtiment loué dans le proche quartier de Ramesh Park à Laxmi Nagar. Les locaux offraient également un lieu de vie aux enfants sans parents ou qui ne trouveraient pas un logement.</br></br>
L’association Shanti Delhi devint Jivan Association caritative en été 2006.</br></br>
Le premier groupe d’étudiants réussit le baccalauréat en 2009 et plusieurs d’entre eux entrèrent à l’université de Delhi.</br></br>
Les étudiants qui ne souhaitaient pas poursuivre leurs études à l’université ont eu la possibilité de se former dans l’installation de parois placoplâtre et créer leur propre entreprise grâce à un partenariat avec l’entreprise Lafarge qui établissait alors en Inde son activité dans le gypse. Les premières sociétés de partenariat ont été créées en 2010 et sont à ce jour toujours en activité.</br></br>
En 2015, SVM a fêté ses 20 ans d’existence et plus de 1000 élèves avaient fréquenté l’école depuis sa création. Beaucoup d’entre eux ont eu de belles opportunités, l’assurance d’une vie meilleure pour eux et leurs familles.</br></br>
...
"Give to Jivan through the PayPal Giving Fund. PayPal generously covers all transaction fees so 100% of your donation goes to Jivan.",
    ...
    "timeline_p" => "SVM Education Center, financée par Jivan Association caritative en Suisse, prend annuellement en charge depuis 22 ans 225 enfants des bidonvilles de New Delhi.<br/>
L’école comprend douze degrés incluant le baccalauréat et l’enseignement est donné en Anglais, Hindi et Urdu. SVM n’a pas pour seul objectif l’instruction mais également l’accompagnement des enfants dans leur développement personnel, amener la confiance dans leur coeur et le sourire dans leur vie. C’est un voyage que nous faisons ensemble depuis 1996 avec les élèves, avec leurs parents quand les enfants ne sont pas seuls et les enseignants de SVM.",
    "timeline" => array(
	    array(
		    "date" => "1973",
		    "desc" => "Sophie Rombaut débute son travail caritative dans un bidonville de New Delhi",
		    "img" => "./assets/imgs/timeline/1.jpg"),
	    array(
		    "date" => "1995",
		    "desc" => "Ouverture de l’école SVM, degrés 1 à 6, dans le bidonville de I.T.O.",
		    "img" => "./assets/imgs/timeline/2.jpg"),
	    array(
		    "date" => "1996",
		    "desc" => "Anita Bula rencontre Sophie Rombaut",
		    "img" => "./assets/imgs/timeline/3.jpg"),
	    array(
		    "date" => "1999",
		    "desc" => "Swissair débute son soutien à SVM",
		    "img" => "./assets/imgs/timeline/4.jpg"),
	    array(
		    "date" => "2000",
		    "desc" => "Ouverture de classes supplémentaires à SVM",
		    "img" => "./assets/imgs/timeline/5.jpg"),
	    array(
		    "date" => "2006",
		    "desc" => "Destruction du bidonville de I.T.O., installation de SVM à Laxmi Nagar",
		    "img" => "./assets/imgs/timeline/6.jpg"),
	    array(
		    "date" => "2006",
		    "desc" => "Shanti Delhi devient Jivan",
		    "img" => "./assets/imgs/timeline/7.jpg"),
	    array(
		    "date" => "2009",
		    "desc" => "Premiers élèves à obtenir le baccalauréat",
		    "img" => "./assets/imgs/timeline/8.jpg"),
	    array(
		    "date" => "2015",
		    "desc" => "SVM fête ses vingt ans et 1000 élèves depuis sa création",
		    "img" => "./assets/imgs/timeline/9.jpg"),
	    array(
		    "date" => "2017",
		    "desc" => "Ouverture d’une classe dans un bidonville à proximité de Laxmi Nagar",
		    "img" => "./assets/imgs/timeline/10.jpg"),
    )
);
